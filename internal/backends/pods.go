...
func PodSource(cs *kubernetes.Clientset, namespace string) ResourceSource {
	...
	podsBackend.LoadFunctions(
		cs.CoreV1().Pods(namespace).Get,
		cs.CoreV1().Pods(namespace).List,
	)
