...
func ServiceAccountSource(cs *kubernetes.Clientset, namespace string) ResourceSource {
	...
	source.LoadFunctions(
		cs.CoreV1().ServiceAccounts(namespace).Get,
		cs.CoreV1().ServiceAccounts(namespace).List,
	)
